...
export _LED_0_Switch
export  LED_0_Switch

export _LED_0_Invert
export  LED_0_Invert

export _LED_0_GetState
export  LED_0_GetState
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_0_Start(void)
;  FUNCTION NAME: LED_0_Stop(void)
;
;  FUNCTION NAME: LED_0_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(1)                                            ; Active High Digit Drive
   or   [Port_1_Data_SHADE],LED_0_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_1_Data_SHADE],~LED_0_PinMask
ENDIF
   jmp  .Switch_LED
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_0_Invert(void)
;
;  DESCRIPTION:
;     Invert state of LED                               
;
...
_LED_0_Invert:
 LED_0_Invert:
   ...
   xor  [Port_1_Data_SHADE],LED_0_PinMask
   mov  A,[Port_1_Data_SHADE]
   mov  reg[LED_0_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_0_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,LED_0_PinMask               ; Mask off the trash
