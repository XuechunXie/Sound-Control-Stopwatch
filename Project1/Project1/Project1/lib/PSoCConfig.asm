...
export LoadConfig_project1
export _LoadConfig_project1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_project1
	lcall	LoadConfigTBL_project1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration project1
;
;    Load configuration registers for project1.
...
_LoadConfig_project1:
 LoadConfig_project1:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_project1_Bank0
    mov     X, <LoadConfigTBL_project1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_project1_Bank1
    mov     X, <LoadConfigTBL_project1_Bank1
