...
;       Instance name Counter8_1, Block Name CNTR8(DBB00)
	db		23h, 00h		;Counter8_1_CONTROL_REG(DBB00CR0)
	db		21h, fah		;Counter8_1_PERIOD_REG(DBB00DR1)
	db		22h, 7dh		;Counter8_1_COMPARE_REG(DBB00DR2)
;  Instance name Counter8_2, User Module Counter8
;       Instance name Counter8_2, Block Name CNTR8(DBB01)
	db		27h, 00h		;Counter8_2_CONTROL_REG(DBB01CR0)
	db		25h, fah		;Counter8_2_PERIOD_REG(DBB01DR1)
	db		26h, 7dh		;Counter8_2_COMPARE_REG(DBB01DR2)
...
;  Instance name Counter8_1, User Module Counter8
;       Instance name Counter8_1, Block Name CNTR8(DBB00)
	db		20h, 29h		;Counter8_1_FUNC_REG(DBB00FN)
	db		21h, 11h		;Counter8_1_INPUT_REG(DBB00IN)
	db		22h, 40h		;Counter8_1_OUTPUT_REG(DBB00OU)
;  Instance name Counter8_2, User Module Counter8
;       Instance name Counter8_2, Block Name CNTR8(DBB01)
	db		24h, 29h		;Counter8_2_FUNC_REG(DBB01FN)
	db		25h, 11h		;Counter8_2_INPUT_REG(DBB01IN)
	db		26h, 40h		;Counter8_2_OUTPUT_REG(DBB01OU)
;  Instance name LCD, User Module LCD
;  Instance name LED_1, User Module LED
;  Instance name LED_2, User Module LED
;  Instance name LED_3, User Module LED
;  Global Register values Bank 1
	...
	db		e1h, 2fh		; OscillatorControl_1 register (OSC_CR1)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[04h], 07h		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], f8h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
